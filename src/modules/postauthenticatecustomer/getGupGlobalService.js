...
module.exports = async function(req, res, instance) {
    ...
    try{
        ...
        if(error.event === EXCEPTIONEVENT.MISSING_OR_INVALID_PARAMETER){
            ...
            LOG.SUMMARYLOG.ERROR(instance, nodeName, commandName, resultCode, resultDesc);
            LOG.STAT.call(this, STAT.AAF_SDF_GET_GUP_GLOBAL_SERVICE_RECEIVED_ERROR);
            utils.postAuthenticateCustomerResponse.call(this, instance, res, STATUS.DATA_EXIST, STAT.AAF_RETURN_POST_AUTHENTICATECUSTOMER_ERROR, undefined, undefined, undefined, error.message, errMessageStack , errMessageStacks)
    ...
    let serviceId = await globalService.getServiceIdByAppName(instance, instance.postAuthenticateCustomerRequest.appName, getGupGlobalServiceResponse);
    LOG.DEBUG.DEBUG.call(this, `ServicId is ${serviceId}`);
    instance.serviceId = serviceId;
    if(validator.isDefinedValue(serviceId) === false){
        utils.postAuthenticateCustomerResponse.call(this, instance, res, STATUS.DATA_NOT_FOUND, STAT.AAF_RETURN_POST_AUTHENTICATECUSTOMER_ERROR, undefined, undefined, undefined, `Not found service ${instance.postAuthenticateCustomerRequest.appName}`, undefined , undefined)
        return;
    }else{        
