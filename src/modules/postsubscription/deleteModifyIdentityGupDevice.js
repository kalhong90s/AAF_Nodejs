...
module.exports = async function(req, res, instance) {
    ...
    let deleteModifyGupDeviceResponse = instance.deleteModifyGupDeviceResponse;
    instance.currentState = STATE.W_DELETE_MODIFYIDENTITY_GUPDEVICE;
    let data;

    if(validator.isDefinedValue(deleteModifyGupDeviceResponse)){
        data = deleteModifyGupDeviceResponse.data;
    ...
    try{
        sdfValidate.validatePostModifyIdentityResponse(deleteModifyGupDeviceResponse);
