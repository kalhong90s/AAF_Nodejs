...
module.exports = async function(req, res, instance) {
    ...
    let deleteModifyGupImpiResponse = instance.deleteModifyGupImpiResponse;
    instance.currentState = STATE.W_DELETE_MODIFYIDENTITY_GUPIMPI;
    let data;

    if(validator.isDefinedValue(deleteModifyGupImpiResponse)){
        data = deleteModifyGupImpiResponse.data;
    ...
    try{
        sdfValidate.validatePostModifyIdentityResponse(deleteModifyGupImpiResponse);
