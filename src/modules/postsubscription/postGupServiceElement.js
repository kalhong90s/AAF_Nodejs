...
module.exports = async function(req, res, instance) {
    ...
    let commandName = COMMAND.POST_GUPSERVICEELEMENT;

    let postGupServiceElementResponse = instance.postGupServiceElementResponse;
    instance.currentState = STATE.W_POST_GUPSERVICEELEMENT;
    let data;
    let resultCode;
    let resultDesc;
    let errMessageStacks;

    if(validator.isDefinedValue(postGupServiceElementResponse)){
        data = postGupServiceElementResponse.data;
        if(validator.isDefinedValue(data)){
            resultCode = data.resultCode;
            resultDesc = data.resultDescription;
            errMessageStacks = data.errorMessageStack;
        }else{
            resultCode = postGupServiceElementResponse.statusCode;
            resultDesc = postGupServiceElementResponse.statusMessage;
        }
    }
    ...
    try{
        sdfValidate.validatePostGupServiceElementResponse(postGupServiceElementResponse);
        LOG.STAT.call(this, STAT.AAF_SDF_POST_GUP_SERVICEELEMENT_RESPONSE);
    }catch(error){
        ...
        if(error.event === EXCEPTIONEVENT.MISSING_OR_INVALID_PARAMETER){
            ...
            LOG.STAT.call(this, STAT.AAF_SDF_POST_GUP_SERVICEELEMENT_RECEIVED_BAD);
            ...
            LOG.SUMMARYLOG.ERROR(instance, nodeName, commandName, resultCode, resultDesc);
            LOG.STAT.call(this, STAT.AAF_SDF_POST_GUP_SERVICEELEMENT_RECEIVED_ERROR);
            ...
            LOG.SUMMARYLOG.ERROR(instance, nodeName, commandName, resultCode, resultDesc);
            LOG.STAT.call(this, STAT.AAF_SDF_POST_GUP_SERVICEELEMENT_RECEIVED_TIMEOUT);
            ...
            LOG.SUMMARYLOG.ERROR(instance, nodeName, commandName, resultCode, resultDesc);
            LOG.STAT.call(this, STAT.AAF_SDF_POST_GUP_SERVICEELEMENT_RECEIVED_CONNECTION_ERROR);
