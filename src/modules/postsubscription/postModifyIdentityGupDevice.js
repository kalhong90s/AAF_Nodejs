...
module.exports = async function(req, res, instance) {
    ...
    let postModifyGupDeviceResponse = instance.postModifyGupDeviceResponse;
    ...
    if(validator.isDefinedValue(postModifyGupDeviceResponse)){
        data = postModifyGupDeviceResponse.data;
        if(validator.isDefinedValue(data)){
            resultCode = data.resultCode;
            resultDesc = data.resultDescription;
            errMessageStacks = data.errorMessageStack;
        }else{
            resultCode = postModifyGupDeviceResponse.statusCode;
            resultDesc = postModifyGupDeviceResponse.statusMessage;
        }
    }
    ...
    try{
        sdfValidate.validatePostModifyIdentityResponse(postModifyGupDeviceResponse);
    ...
    await utils.postGupDevice.call(this, instance);
    return;
