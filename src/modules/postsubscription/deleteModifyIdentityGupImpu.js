...
module.exports = async function(req, res, instance) {
    ...
    let deleteModifyGupImpuResponse = instance.deleteModifyGupImpuResponse;
    instance.currentState = STATE.W_DELETE_MODIFYIDENTITY_GUPIMPU;
    let data;

    if(validator.isDefinedValue(deleteModifyGupImpuResponse)){
        data = deleteModifyGupImpuResponse.data;
    ...
    try{
        sdfValidate.validatePostModifyIdentityResponse(deleteModifyGupImpuResponse);
