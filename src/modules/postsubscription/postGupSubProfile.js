...
module.exports = async function(req, res, instance) {
    ...
    let commandName = COMMAND.POST_GUPSUBPROFILE;

    let postGupSubProfileResponse = instance.postGupSubProfileResponse;
    instance.currentState = STATE.W_POST_GUPSUBPROFILE;
    let data;
    let resultCode;
    let resultDesc;
    let errMessageStacks;

    if(validator.isDefinedValue(postGupSubProfileResponse)){
        data = postGupSubProfileResponse.data;
        if(validator.isDefinedValue(data)){
            resultCode = data.resultCode;
            resultDesc = data.resultDescription;
            errMessageStacks = data.errorMessageStack;
        }else{
            resultCode = postGupSubProfileResponse.statusCode;
            resultDesc = postGupSubProfileResponse.statusMessage;
        }
    }
    ...
    try{
        sdfValidate.validatePostGupImpuResponse(postGupSubProfileResponse);
        LOG.STAT.call(this, STAT.AAF_SDF_POST_GUP_SUB_PROFILE_RESPONSE);
    }catch(error){
        ...
        if(error.event === EXCEPTIONEVENT.MISSING_OR_INVALID_PARAMETER){
            ...
            LOG.STAT.call(this, STAT.AAF_SDF_POST_GUP_SUB_PROFILE_RECEIVED_BAD);
            ...
            LOG.SUMMARYLOG.ERROR(instance, nodeName, commandName, resultCode, resultDesc);
            LOG.STAT.call(this, STAT.AAF_SDF_POST_GUP_SUB_PROFILE_RECEIVED_ERROR);
            ...
            LOG.SUMMARYLOG.ERROR(instance, nodeName, commandName, resultCode, resultDesc);
            LOG.STAT.call(this, STAT.AAF_SDF_POST_GUP_SUB_PROFILE_RECEIVED_TIMEOUT);
            ...
            LOG.SUMMARYLOG.ERROR(instance, nodeName, commandName, resultCode, resultDesc);
            LOG.STAT.call(this, STAT.AAF_SDF_POST_GUP_SUB_PROFILE_RECEIVED_CONNECTION_ERROR);
